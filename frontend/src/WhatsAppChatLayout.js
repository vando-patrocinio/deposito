...
import {
  Avatar, avatarColor, ChannelBadge, IconBtn,
  StatusPill, StatCard, Section, FieldRow, TicketHistRow,
  _kpiCsatColor, _kpiFmtSecs, _findPrevUserQuestion,
  extractErrorFromAxios,
} from "@/components/wa/atoms";
...
/* =============================================================
   ...
   Componentes atômicos (Avatar, IconBtn, StatusPill, etc.) extraídos
   em iter106 para components/wa/atoms.js — importados acima.
============================================================= */
...
// StatusPill, StatCard, Section, FieldRow, TicketHistRow — movidos para
// components/wa/atoms.js em iter106 (refactor).
...
/* AttendantKpiStrip — drill-down inverso: mostra KPIs do atendente
   ...
   _kpiCsatColor e _kpiFmtSecs movidos para components/wa/atoms.js */
...
/* extractErrorFromAxios — movido para components/wa/atoms.js em iter106. */
