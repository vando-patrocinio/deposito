"""DEPRECATED · services.real_revenue
=====================================

Renomeado para `services.revenue_realization` em 15/06/2026 (Etapa 3 —
Ligo Executive OS · Consolidation).
...
e depois será removido. Atualize seus imports para:
    ...
    # ou
    from services.revenue_realization import <símbolo>
...
from services import revenue_realization as _target

_LEGACY_PATH = "services.real_revenue"
_TARGET_PATH = "services.revenue_realization"
